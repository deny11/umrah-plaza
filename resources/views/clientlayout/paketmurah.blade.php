<section class="content_info" style="background-color: white;">
    ...
    <div class="padding-bottom">
        ...
        <div class="container">
            <div class="row">
                <div class="titles">
                    <h2>Pilihan Paket <span>Terdekat</span></h2>
        ...
        <div id="boxes-carousels">
            ...
            @foreach($soon as $item)
                ...
                @endif
                    ...
                    <div class="price">
						<b>From</b>
						<span>@if($item->currency_id == 1) Rp @elseif($item->currency_id == 2) $ @endif</span>
						@if($item->currency_id == 1)
                            {{number_format($item->price_quadruple,0,',','.') }}
                        @elseif($item->currency_id == 2)
                            {{number_format($item->price_quadruple,2,',','.') }}
                        @endif
					</div>
					</div>
				</div>
        ...
        <div id="boxes-carousel">
            ...
            <div>
                ...
                <div class="info-gallery">
                    ...
                    <p>{{substr($item->description,0,60)}}...</p>
                    <div class="content-btn"><a href="{{URL::to('paket/detail/').'/'.$item->id}}" class="btn btn-primary">View Details</a></div>
                    <div class="price"><b>From</b><span>@if($item->currency_id == 1) Rp @elseif($item->currency_id == 2) $ @endif</span>@if($item->currency_id == 1)
                            {{number_format($item->price_quadruple,0,',','.') }}
                        @elseif($item->currency_id == 2)
                            {{number_format($item->price_quadruple,2,',','.') }}
                        @endif</div>
