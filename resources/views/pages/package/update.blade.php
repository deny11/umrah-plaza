                ...
                <form action="{{ route('packages.update', ['id' => $item->id]) }}" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                            <input value="{{$item->schedule}}" name="schedule" required type="text" class="form-control has-feedback-left" id="single_cal1" placeholder="Tanggal" aria-describedby="inputSuccess2Status">
					...
					<!-- <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control"  name="is_discount_in_percentage" id="">
                                <option value="true"<?php //echo ($item->is_discount_in_percentage == 1)?'selected':''?>>Dalam persentase</option>
                                <option value="false"<?php //echo ($item->is_discount_in_percentage == 0)?'selected':''?>>Dalam harga</option>
                            </select>
                        </div>
                    </div>
					-->
					<div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" value="{{$item->payment_time_range}}" name="payment_time_range" placeholder="dalam satuan jam" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
